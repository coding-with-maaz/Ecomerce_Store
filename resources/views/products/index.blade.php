...
@section('title', 'Products - Medzfitt')
                    ...
                    <div class="mb-8">
                        ...
                        <ul class="space-y-2">
                            ...
                            @foreach(\App\Models\Category::active()->ordered()->get() as $cat)
                                <li>
                                    <a href="{{ route('products.category', $cat->slug) }}" class="flex items-center justify-between p-3 rounded-lg hover:bg-blue-50 transition group">
                                        <span class="text-gray-700 group-hover:text-blue-600">{{ $cat->name }}</span>
                                        <i class="fas fa-chevron-right text-gray-400 group-hover:text-blue-600"></i>
                                    </a>
                                </li>
                            @endforeach
