...
<?php $__env->startSection('title', 'Medzfitt - Premium Medical Wear'); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 items-center min-h-[550px]">
                    <div class="py-16 lg:py-0">
                        ...
                        <div class="flex flex-wrap gap-4 animate-fadeInUp animation-delay-400">
                            <a href="<?php echo e(route('products.index')); ?>" class="bg-blue-600 text-white px-8 py-4 rounded-lg hover:bg-blue-700 transition flex items-center text-lg font-semibold shadow-lg">
                                <i class="fas fa-tag mr-2"></i>
                                SALE ITEMS
                            </a>
                            <a href="<?php echo e(route('products.category', 'accessories')); ?>" class="bg-white text-gray-800 px-8 py-4 rounded-lg hover:bg-gray-100 transition flex items-center text-lg font-semibold shadow-lg">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 items-center min-h-[550px]">
                    <div class="py-16 lg:py-0">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="<?php echo e(route('products.category', 'strechtable-scrub')); ?>" class="bg-yellow-400 text-gray-900 px-8 py-4 rounded-lg hover:bg-yellow-300 transition flex items-center text-lg font-semibold shadow-lg">
                                <i class="fas fa-star mr-2"></i>
                                SHOP NOW
                            </a>
                            <a href="<?php echo e(route('products.index')); ?>" class="bg-white text-gray-800 px-8 py-4 rounded-lg hover:bg-gray-100 transition flex items-center text-lg font-semibold shadow-lg">
                                VIEW ALL
                            </a>
                        </div>
                    </div>
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="grid grid-cols-1 lg:grid-cols-2 items-center min-h-[550px]">
                    <div class="py-16 lg:py-0">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="<?php echo e(route('products.category', 'washing-wear-scrub-for-women')); ?>" class="bg-pink-500 text-white px-8 py-4 rounded-lg hover:bg-pink-600 transition flex items-center text-lg font-semibold shadow-lg">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php $__currentLoopData = $categories->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('products.category', $category->slug)); ?>" class="group">
                            ...
                            <?php else: ?>
                                ...
                                <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-100 to-blue-200">
                                    <div class="text-center">
                                        <i class="fas fa-<?php echo e($index % 3 == 0 ? 'user-md' : ($index % 3 == 1 ? 'tshirt' : 'briefcase-medical')); ?> text-8xl text-blue-400 mb-4"></i>
                                        <p class="text-blue-600 font-semibold text-lg"><?php echo e($category->name); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
        ...
        <div class="text-center mt-12">
            <a href="<?php echo e(route('products.index')); ?>" class="inline-block bg-gray-900 text-white px-10 py-4 rounded-lg hover:bg-gray-800 transition-all text-lg font-semibold shadow-lg">
                                ...
                                <?php if($product->sale_price): ?>
                                    <div class="absolute top-4 left-4">
                                        <span class="bg-red-600 text-white text-xs font-bold px-4 py-2 rounded-full shadow-lg">
                                            SALE -<?php echo e($product->discount_percentage); ?>%
                                        </span>
                                    </div>
                                <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <div class="text-center py-16">
                <div class="bg-gray-50 rounded-2xl p-12 max-w-2xl mx-auto">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="inline-block bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition">
                        Browse All Products
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\moviebox\Ibrahim\medzfitt-laravel\resources\views/home.blade.php ENDPATH**/ ?>